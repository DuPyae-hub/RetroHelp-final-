...
export const translations = {
  en: {
    ...
    home: {
      ...
      reviewsAggregateBadge: 'Centre rating',
      reviewsAggregateNote: 'Average from all community ratings at this centre.',
    ...
    library: {
      ...
      chipEbooks: 'Mental-health eBooks',
      minimalHint: 'Short cards + optional eBook links for extra support.',
      ebooksTitle: 'Mental & psychosocial eBooks',
      emptyEbooks: 'No mental-support eBooks yet.',
    ...
    staffDash: {
      ...
      articleEbookUrl: 'eBook URL (optional)',
      ...
      presetPsychosocial: 'Preset: Psychosocial eBook',
  ...
  my: {
    ...
    home: {
      ...
      reviewsAggregateBadge: 'စင်တာ အမှတ်ပေး',
      reviewsAggregateNote: 'ဤစင်တာရှိ အသိုင်းအဝိုင်း အမှတ်ပေးများ၏ ပျမ်းမျှ။',
    ...
    library: {
      ...
      chipEbooks: 'စိတ်ကျန်းမာရေး eBook များ',
      minimalHint: 'အကျဉ်းချုပ်ကတ်များနှင့် လိုအပ်ပါက eBook လင့်ခ်များ။',
      ebooksTitle: 'စိတ်ပိုင်းနှင့် လူမှုစိတ်ပိုင်းဆိုင်ရာ eBook များ',
      emptyEbooks: 'စိတ်ပိုင်းဆိုင်ရာ eBook မရှိသေးပါ။',
      openEbook: 'eBook ဖွင့်ရန်',
    ...
    staffDash: {
      ...
      articleEbookUrl: 'eBook URL (မထည့်လည်းရ)',
